...
const cardItems: CardItem[] = [
  ...
  },
  {
    id: 3,
    title:
      `SSU-${CENTER_NAME} Strengthens Partnerships for Gender-Responsive and Sustainable Youth Development`,
  ...
  },
  {
    id: 4,
    title:
      `SSU-${CENTER_NAME} Advances Digital Biodiversity Monitoring Through KalikaScan Beta Testing`,
  ...
  },
  {
    id: 5,
    title:
      `${CENTER_NAME} Shines at 2026 RDE Kick-Off with Multiple Research and Innovation Awards`,
